...
from services.chat_service_new import get_active_chat, end_chat, increment_messages_count
...
async def send_media_message(bot: Bot, partner_id: int, message: types.Message) -> Optional[types.Message]:
    ...
    try:
        ...
        if content_type == "photo":
            return await bot.send_photo(partner_id, file_id, caption=caption)
        elif content_type == "video":
            return await bot.send_video(partner_id, file_id, caption=caption)
        elif content_type == "voice":
            return await bot.send_voice(partner_id, file_id)
        elif content_type == "document":
            return await bot.send_document(partner_id, file_id, caption=caption)
        elif content_type == "audio":
            return await bot.send_audio(partner_id, file_id, caption=caption)
        elif content_type == "sticker":
            return await bot.send_sticker(partner_id, file_id)
    except Exception as e:
